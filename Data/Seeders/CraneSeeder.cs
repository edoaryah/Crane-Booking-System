  ...
  public static class CraneSeeder
  {
    public static void Seed(ModelBuilder modelBuilder)
    {
      modelBuilder.Entity<Crane>().HasData(
          ...
          new Crane { Id = 2, Code = "LC009", Capacity = 100, Ownership = CraneOwnership.KPC },
          new Crane { Id = 3, Code = "LC010", Capacity = 150, Ownership = CraneOwnership.KPC },
          new Crane { Id = 4, Code = "LC011", Capacity = 100, Ownership = CraneOwnership.KPC },
